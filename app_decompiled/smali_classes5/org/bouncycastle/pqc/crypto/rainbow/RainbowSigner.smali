...
.method private genSignature([B)[B
    ...
    aget-short v10, v6, v15

    invoke-static {v10, v5}, Lorg/bouncycastle/pqc/crypto/rainbow/GF2Field;->addElem(SS)S

    move-result v5

    aput-short v5, v6, v15
    ...
    iget-object v10, v8, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowPrivateKeyParameters;->l2_F1:[[[S

    aget-object v10, v10, v5

    invoke-virtual {v6, v10, v9}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix_quad([[S[S)S
    ...
    iget-object v10, v8, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowPrivateKeyParameters;->l2_F2:[[[S
    ...
    invoke-static {v10, v15}, Lorg/bouncycastle/pqc/crypto/rainbow/GF2Field;->multElem(SS)S

    move-result v10

    aget-object v15, v25, v5

    aget-short v14, v15, v6

    invoke-static {v14, v10}, Lorg/bouncycastle/pqc/crypto/rainbow/GF2Field;->addElem(SS)S

    move-result v10

    aput-short v10, v15, v6
    ...
    iget-object v10, v8, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowPrivateKeyParameters;->l2_F3:[[[S
    ...
    invoke-static {v10, v14}, Lorg/bouncycastle/pqc/crypto/rainbow/GF2Field;->multElem(SS)S
    ...
    invoke-static {v15, v10}, Lorg/bouncycastle/pqc/crypto/rainbow/GF2Field;->addElem(SS)S

    move-result v10

    aput-short v10, v14, v6
    ...
    iget-object v10, v0, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowSigner;->random:Ljava/security/SecureRandom;
    ...
    invoke-static {v10, v14, v15, v5}, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowUtil;->hash(Lorg/bouncycastle/crypto/Digest;[B[B[B)[B

    move-result-object v10

    invoke-direct {v0, v10}, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowSigner;->makeMessageRepresentative([B)[S
    ...
    invoke-static {v10, v3, v2}, Lorg/bouncycastle/util/Arrays;->copyOfRange([SII)[S

    move-result-object v15

    invoke-virtual {v5, v14, v15}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix([[S[S)[S
    ...
    invoke-static {v10, v3}, Lorg/bouncycastle/util/Arrays;->copyOf([SI)[S
    ...
    invoke-static {v10, v3, v14, v3, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-virtual {v5, v11, v10}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->addVect([S[S)[S
    ...
    invoke-virtual {v10, v13, v5}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix([[S[S)[S
    ...
    invoke-virtual {v10, v15, v5}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix([[S[S)[S
    ...
    invoke-virtual {v13, v15, v5}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix_quad([[S[S)S

    move-result v13

    aput-short v13, v19, v11
    ...
    invoke-virtual {v11, v10, v13}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->addVect([S[S)[S

    move-result-object v10

    iget-object v11, v0, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowSigner;->cf:Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;

    invoke-virtual {v11, v10, v12}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->addVect([S[S)[S
    ...
    invoke-virtual {v11, v10, v15}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->addVect([S[S)[S
    ...
    iget-object v12, v8, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowPrivateKeyParameters;->l2_F6:[[[S
    ...
    invoke-static {v12, v13}, Lorg/bouncycastle/pqc/crypto/rainbow/GF2Field;->multElem(SS)S
    ...
    aget-short v5, v13, v2

    invoke-static {v5, v12}, Lorg/bouncycastle/pqc/crypto/rainbow/GF2Field;->addElem(SS)S
    ...
    invoke-virtual {v6, v2, v10}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->solveEquation([[S[S)[S
    ...
    iget-object v5, v8, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowPrivateKeyParameters;->t1:[[S

    invoke-virtual {v2, v5, v6}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix([[S[S)[S

    move-result-object v2

    iget-object v5, v0, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowSigner;->cf:Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;

    invoke-virtual {v5, v9, v2}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->addVect([S[S)[S
    ...
    invoke-virtual {v5, v9, v10}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix([[S[S)[S
    ...
    invoke-virtual {v9, v2, v5}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->addVect([S[S)[S
    ...
    invoke-virtual {v5, v8, v10}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->multiplyMatrix([[S[S)[S
    ...
    invoke-virtual {v8, v6, v5}, Lorg/bouncycastle/pqc/crypto/rainbow/ComputeInField;->addVect([S[S)[S

    move-result-object v5

    move/from16 v6, v17

    invoke-static {v2, v6}, Lorg/bouncycastle/util/Arrays;->copyOf([SI)[S

    move-result-object v2

    const/4 v6, 0x0

    invoke-static {v5, v6, v2, v1, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    add-int/2addr v3, v1

    invoke-static {v10, v6, v2, v3, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    const/high16 v1, 0x10000

    if-eq v7, v1, :cond_10

    invoke-static {v2}, Lorg/bouncycastle/pqc/crypto/rainbow/RainbowUtil;->convertArray([S)[B
