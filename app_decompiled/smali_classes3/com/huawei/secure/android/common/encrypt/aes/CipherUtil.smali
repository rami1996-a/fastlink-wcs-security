...
.method private static a([B[BI)Ljavax/crypto/Cipher;
    ...
    const-string p1, "cbc iv param is not right"
...
.method private static b([B[BI)Ljavax/crypto/Cipher;
    ...
    const-string p1, "gcm iv param is not right"
...
.method public static getContent(Lcom/huawei/secure/android/common/encrypt/aes/CipherConfig;)I
    .locals 6
    ...
    .line 13
    :cond_0
    invoke-virtual {p0}, Lcom/huawei/secure/android/common/encrypt/aes/CipherConfig;->getCipher()Ljavax/crypto/Cipher;

    move-result-object v0

    invoke-virtual {p0}, Lcom/huawei/secure/android/common/encrypt/aes/CipherConfig;->getInput()[B

    move-result-object v1

    invoke-virtual {p0}, Lcom/huawei/secure/android/common/encrypt/aes/CipherConfig;->getInputOffset()I

    move-result v2

    .line 14
    invoke-virtual {p0}, Lcom/huawei/secure/android/common/encrypt/aes/CipherConfig;->getInputLen()I

    move-result v3

    invoke-virtual {p0}, Lcom/huawei/secure/android/common/encrypt/aes/CipherConfig;->getOutput()[B

    move-result-object v4

    invoke-virtual {p0}, Lcom/huawei/secure/android/common/encrypt/aes/CipherConfig;->getOutputOffset()I

    move-result v5

    .line 15
    invoke-static/range {v0 .. v5}, Lcom/huawei/secure/android/common/encrypt/aes/CipherUtil;->getContent(Ljavax/crypto/Cipher;[BII[BI)I
