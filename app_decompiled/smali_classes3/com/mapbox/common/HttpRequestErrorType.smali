...
.source "HttpRequestErrorType.java"
...
.method static constructor <clinit>()V
    ...
    .line 10
    new-instance v1, Lcom/mapbox/common/HttpRequestErrorType;
    ...
    invoke-direct {v1, v4, v2, v3}, Lcom/mapbox/common/HttpRequestErrorType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v1, Lcom/mapbox/common/HttpRequestErrorType;->SSLERROR:Lcom/mapbox/common/HttpRequestErrorType;

    .line 12
    new-instance v2, Lcom/mapbox/common/HttpRequestErrorType;

    const/4 v3, 0x2

    const-string v4, "RequestCancelled"

    const-string v5, "REQUEST_CANCELLED"

    invoke-direct {v2, v5, v3, v4}, Lcom/mapbox/common/HttpRequestErrorType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v2, Lcom/mapbox/common/HttpRequestErrorType;->REQUEST_CANCELLED:Lcom/mapbox/common/HttpRequestErrorType;

    .line 14
    new-instance v3, Lcom/mapbox/common/HttpRequestErrorType;

    const/4 v4, 0x3

    const-string v5, "RequestTimedOut"

    const-string v6, "REQUEST_TIMED_OUT"

    invoke-direct {v3, v6, v4, v5}, Lcom/mapbox/common/HttpRequestErrorType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v3, Lcom/mapbox/common/HttpRequestErrorType;->REQUEST_TIMED_OUT:Lcom/mapbox/common/HttpRequestErrorType;

    .line 16
    new-instance v4, Lcom/mapbox/common/HttpRequestErrorType;

    const/4 v5, 0x4

    const-string v6, "RangeError"

    const-string v7, "RANGE_ERROR"

    invoke-direct {v4, v7, v5, v6}, Lcom/mapbox/common/HttpRequestErrorType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v4, Lcom/mapbox/common/HttpRequestErrorType;->RANGE_ERROR:Lcom/mapbox/common/HttpRequestErrorType;

    .line 18
    new-instance v5, Lcom/mapbox/common/HttpRequestErrorType;

    const/4 v6, 0x5

    const-string v7, "OtherError"

    const-string v8, "OTHER_ERROR"

    invoke-direct {v5, v8, v6, v7}, Lcom/mapbox/common/HttpRequestErrorType;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    sput-object v5, Lcom/mapbox/common/HttpRequestErrorType;->OTHER_ERROR:Lcom/mapbox/common/HttpRequestErrorType;
...
.method private getValue()I
    ...
    .line 32
    invoke-virtual {p0}, Lcom/mapbox/common/HttpRequestErrorType;->ordinal()I
